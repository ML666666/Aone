...
const state = {
  ...
  chinese: {
    ...
    aboutMe:{
      article:"文章",
      video:"视频",
      step_1Tips:"切换“文章”和“视频”快速学习区块链知识",
      step_2Tips:"点击进入了解“详细行情”",
      gotIt:"我知道了",
      news:"快讯",
      interpretation:"解读",
      step_3Tips:"切换“快讯”和“解读”快速了解市场动态",
      step_4Tips:"切换“BTC”、“LTC”和“ETH” 进入C2C页面",
      step_5Tips:"点击按钮进行“看涨”或“看跌”操作",
      step_6Tips:"每个新用户仅有3次体验购买“2手”的机会。双击“自定义”还可以输入手数噢！",
      hand:"手",
      custom:"自定义"
    },
    infoPage:{
  ...
  upChinese: {
    ...
    aboutMe:{
      article:"文章",
      video:"視頻",
      step_1Tips:"切換“文章”和“視頻”快速學習區塊鏈知識",
      step_2Tips:"點擊進入了解“詳細行情”",
      gotIt:"我知道了",
      news:"快訊",
      interpretation:"解讀",
      step_3Tips:"切換“快訊”和“解讀”快速了解市場動態",
      step_4Tips:"切換“BTC”、“LTC”和“ETH” 進入C2C頁面",
      step_5Tips:"點擊按鈕進行“看漲”或“看跌”操作",
      step_6Tips:"每個新用戶僅有3次體驗購買“2手”的機會。雙擊“自定義”還可以輸入手數噢！",
      hand:"手",
      custom:"自定義"
    },
    infoPage:{
  ...
  English:{
    ...
    aboutMe:{
      article:"article",
      video:"video",
      step_1Tips:"Switch \"article\" and \"video\" to quickly learn blockchain knowledge",
      step_2Tips:"Click on \"detailed market\"",
      gotIt:"got It",
      news:"news",
      interpretation:"interpretation",
      step_3Tips:"Switch \"alerts\" and \"readings\" to quickly understand market dynamics",
      step_4Tips:"Switch \"BTC,\" \"LTC\" and \"ETH\" to the C2C page",
      step_5Tips:"Click the button for a \"bullish\" or \"bearish\" operation",
      step_6Tips:"Each new user only has three opportunities to buy \"two hands\". Double click \"custom\" can also enter the number of hands oh!",
      hand:"H",
      custom:"custom"
    },
    infoPage:{
    ...
    Switch_Head:{
      title:"Switch head",
      Select_photo:"Select a photo from album",
      Cancel:"Cancel",
  ...
  Japanese: {
    ...
    aboutMe:{
      article:"文章",
      video:"動画",
      step_1Tips:"「文章」と「ビデオ」を切り替えることで、ブロック・チェーンの知識を早く学習する。",
      step_2Tips:"アクセスをクリックして「詳しい相場」を知る",
      gotIt:"承知しました",
      news:"速報",
      interpretation:"解読",
      step_3Tips:"「速報」と「解読」を切り替えて市場の動向を理解する。",
      step_4Tips:"「btc」「ltc」と「eth」を切り替えてc2cページに入る。",
      step_5Tips:"ボタンをクリックして「買い」や「見る」動作を行う。",
      step_6Tips:"各新規加入者は「2手」を購入する機会を3回だけ持っている。ダブル「カスタマイズ」で手数を入力してもいい!",
      hand:"手",
      custom:"自定义"
    },
    infoPage:{
