<template>
  <div  style="padding-top: 3.1428rem;">
    ...
    <router-link to="/members/Transaction_Management/buy_order_list">
    ...
    <router-link to="/members/Transaction_Management/sell_order_list">
      <div class="UserDataItem">
        <div class="UserDataItemTitle">
          出售订单
        </div>
    ...
    <router-link to="/members/Transaction_Management/Payment_methods">
      <div class="UserDataItem">
        <div class="UserDataItemTitle">
         收款方式
        </div>
