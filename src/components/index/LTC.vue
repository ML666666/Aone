  ...
  <div class="tradingPage">
    ...
    <div class="choiceGroundWrapper">
      <div class="choiceItemGround">
        <div class="choiceCol">
          <div class="hasHand choiceItem active"  v-bind:class="{'active':hand == 2}">2{{language.hand}}</div>
        ...
        <div class="choiceCol">
          ...
          <!--<div @click="changeHand" class="choiceItem">-->
            <!--<template v-if="!isclickBar">{{language.Customize}}</template>-->
            <!--<template v-if="isclickBar">{{rangeValue[0]}}{{language.hand}}</template>-->
          <!--</div>-->
        </div>
      </div>
