          ...
          return{
            ...
            option:{
              ...
              yAxis: {
                ...
                max: function(value) {
                  return (value.max * 1.0001).toFixed(0);
                },
                min: function(value) {
                  return (value.min * 0.9999).toFixed(0);
                }
              },
              series: [
                {
